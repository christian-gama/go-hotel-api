...
// SaveRoom is an autogenerated mock type for the SaveRoom type
type SaveRoom struct {
	mock.Mock
}

// SaveRoom provides a mock function with given fields: room
func (_m *SaveRoom) SaveRoom(room *entity.Room) (*entity.Room, []*errorutil.Error) {
	ret := _m.Called(room)
...
type mockConstructorTestingTNewSaveRoom interface {
	mock.TestingT
	Cleanup(func())
}

// NewSaveRoom creates a new instance of SaveRoom. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewSaveRoom(t mockConstructorTestingTNewSaveRoom) *SaveRoom {
	mock := &SaveRoom{}
	mock.Mock.Test(t)
